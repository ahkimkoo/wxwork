...
[![GoDoc](https://pkg.go.dev/badge/github.com/ahkimkoo/wxwork?status.svg)](https://pkg.go.dev/github.com/ahkimkoo/wxwork?tab=doc)
[![Go Report Card](https://goreportcard.com/badge/github.com/ahkimkoo/wxwork)](https://goreportcard.com/report/github.com/ahkimkoo/wxwork)

## 快速开始 & demo

```shell script
go get github.com/ahkimkoo/wxwork
```
...
[https://github.com/ahkimkoo/wxwork-demo](https://github.com/ahkimkoo/wxwork-demo)
...
- 丰富的[文档](https://pkg.go.dev/github.com/ahkimkoo/wxwork) / [教程](corporation/doc/SUMMARY.md) 和 [演示代码](https://github.com/ahkimkoo/wxwork-demo) ，快速上手，5 分钟即可搭建一套完整的微信服务
...
只需 [设置 GetAccessTokenFunc 方法](https://pkg.go.dev/github.com/ahkimkoo/wxwork/corporation?tab=doc#App.SetGetAccessTokenHandler) ，从中控服务获取 AccessToken，即可解决多实例刷新冲突/覆盖的问题
